...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_ACCOUNTS_H_
#define  GOOGLE_ANALYTICS_API_ACCOUNTS_H_
 ...
 * @ingroup DataObject
 */
class Accounts : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Accounts(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Accounts(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::Accounts</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::Accounts";
  }
   ...
   */
  const client::JsonCppArray<Account > get_items() const;
   ...
   */
  client::JsonCppArray<Account > mutable_items();
 ...
 private:
  void operator=(const Accounts&);
};  // Accounts
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_ACCOUNTS_H_
