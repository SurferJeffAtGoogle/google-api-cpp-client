...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_ACCOUNT_SUMMARIES_H_
#define  GOOGLE_ANALYTICS_API_ACCOUNT_SUMMARIES_H_
 ...
 * @ingroup DataObject
 */
class AccountSummaries : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit AccountSummaries(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit AccountSummaries(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~AccountSummaries();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_analytics_api::AccountSummaries</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::AccountSummaries";
  }
   ...
   */
  const client::JsonCppArray<AccountSummary > get_items() const;
   ...
   */
  client::JsonCppArray<AccountSummary > mutable_items();
 ...
 private:
  void operator=(const AccountSummaries&);
};  // AccountSummaries
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_ACCOUNT_SUMMARIES_H_
