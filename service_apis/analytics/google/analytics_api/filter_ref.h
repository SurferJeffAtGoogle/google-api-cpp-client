...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_FILTER_REF_H_
#define  GOOGLE_ANALYTICS_API_FILTER_REF_H_
 ...
 * @ingroup DataObject
 */
class FilterRef : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit FilterRef(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit FilterRef(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::FilterRef</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::FilterRef";
  }
 ...
 private:
  void operator=(const FilterRef&);
};  // FilterRef
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_FILTER_REF_H_
