...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_ENTITY_AD_WORDS_LINKS_H_
#define  GOOGLE_ANALYTICS_API_ENTITY_AD_WORDS_LINKS_H_
 ...
 * @ingroup DataObject
 */
class EntityAdWordsLinks : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit EntityAdWordsLinks(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit EntityAdWordsLinks(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~EntityAdWordsLinks();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_analytics_api::EntityAdWordsLinks</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::EntityAdWordsLinks";
  }
   ...
   */
  const client::JsonCppArray<EntityAdWordsLink > get_items() const;
   ...
   */
  client::JsonCppArray<EntityAdWordsLink > mutable_items();
 ...
 private:
  void operator=(const EntityAdWordsLinks&);
};  // EntityAdWordsLinks
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_ENTITY_AD_WORDS_LINKS_H_
