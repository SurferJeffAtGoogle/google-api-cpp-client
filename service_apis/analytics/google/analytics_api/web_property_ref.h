...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_WEB_PROPERTY_REF_H_
#define  GOOGLE_ANALYTICS_API_WEB_PROPERTY_REF_H_
 ...
 * @ingroup DataObject
 */
class WebPropertyRef : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit WebPropertyRef(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit WebPropertyRef(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::WebPropertyRef</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::WebPropertyRef";
  }
 ...
 private:
  void operator=(const WebPropertyRef&);
};  // WebPropertyRef
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_WEB_PROPERTY_REF_H_
