...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_SEGMENTS_H_
#define  GOOGLE_ANALYTICS_API_SEGMENTS_H_
 ...
 * @ingroup DataObject
 */
class Segments : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Segments(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Segments(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::Segments</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::Segments";
  }
   ...
   */
  const client::JsonCppArray<Segment > get_items() const;
   ...
   */
  client::JsonCppArray<Segment > mutable_items();
 ...
 private:
  void operator=(const Segments&);
};  // Segments
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_SEGMENTS_H_
