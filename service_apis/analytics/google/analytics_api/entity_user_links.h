...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_ENTITY_USER_LINKS_H_
#define  GOOGLE_ANALYTICS_API_ENTITY_USER_LINKS_H_
 ...
 * @ingroup DataObject
 */
class EntityUserLinks : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit EntityUserLinks(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit EntityUserLinks(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~EntityUserLinks();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_analytics_api::EntityUserLinks</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::EntityUserLinks";
  }
   ...
   */
  const client::JsonCppArray<EntityUserLink > get_items() const;
   ...
   */
  client::JsonCppArray<EntityUserLink > mutable_items();
 ...
 private:
  void operator=(const EntityUserLinks&);
};  // EntityUserLinks
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_ENTITY_USER_LINKS_H_
