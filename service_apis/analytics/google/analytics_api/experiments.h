...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_EXPERIMENTS_H_
#define  GOOGLE_ANALYTICS_API_EXPERIMENTS_H_
 ...
 * @ingroup DataObject
 */
class Experiments : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Experiments(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Experiments(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::Experiments</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::Experiments";
  }
   ...
   */
  const client::JsonCppArray<Experiment > get_items() const;
   ...
   */
  client::JsonCppArray<Experiment > mutable_items();
 ...
 private:
  void operator=(const Experiments&);
};  // Experiments
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_EXPERIMENTS_H_
