...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_FILTERS_H_
#define  GOOGLE_ANALYTICS_API_FILTERS_H_
 ...
 * @ingroup DataObject
 */
class Filters : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Filters(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Filters(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::Filters</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::Filters";
  }
   ...
   */
  const client::JsonCppArray<Filter > get_items() const;
   ...
   */
  client::JsonCppArray<Filter > mutable_items();
 ...
 private:
  void operator=(const Filters&);
};  // Filters
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_FILTERS_H_
