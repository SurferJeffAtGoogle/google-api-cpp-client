...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_WEBPROPERTIES_H_
#define  GOOGLE_ANALYTICS_API_WEBPROPERTIES_H_
 ...
 * @ingroup DataObject
 */
class Webproperties : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Webproperties(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Webproperties(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~Webproperties();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_analytics_api::Webproperties</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::Webproperties";
  }
   ...
   */
  const client::JsonCppArray<Webproperty > get_items() const;
   ...
   */
  client::JsonCppArray<Webproperty > mutable_items();
 ...
 private:
  void operator=(const Webproperties&);
};  // Webproperties
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_WEBPROPERTIES_H_
