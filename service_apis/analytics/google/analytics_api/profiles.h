...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_PROFILES_H_
#define  GOOGLE_ANALYTICS_API_PROFILES_H_
 ...
 * @ingroup DataObject
 */
class Profiles : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Profiles(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Profiles(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::Profiles</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::Profiles";
  }
   ...
   */
  const client::JsonCppArray<Profile > get_items() const;
   ...
   */
  client::JsonCppArray<Profile > mutable_items();
 ...
 private:
  void operator=(const Profiles&);
};  // Profiles
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_PROFILES_H_
