...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_REMARKETING_AUDIENCES_H_
#define  GOOGLE_ANALYTICS_API_REMARKETING_AUDIENCES_H_
 ...
 * @ingroup DataObject
 */
class RemarketingAudiences : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit RemarketingAudiences(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RemarketingAudiences(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::RemarketingAudiences</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::RemarketingAudiences";
  }
 ...
 private:
  void operator=(const RemarketingAudiences&);
};  // RemarketingAudiences
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_REMARKETING_AUDIENCES_H_
