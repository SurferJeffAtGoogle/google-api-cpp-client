...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_CUSTOM_METRICS_H_
#define  GOOGLE_ANALYTICS_API_CUSTOM_METRICS_H_
 ...
 * @ingroup DataObject
 */
class CustomMetrics : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit CustomMetrics(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit CustomMetrics(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::CustomMetrics</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::CustomMetrics";
  }
   ...
   */
  const client::JsonCppArray<CustomMetric > get_items() const;
   ...
   */
  client::JsonCppArray<CustomMetric > mutable_items();
 ...
 private:
  void operator=(const CustomMetrics&);
};  // CustomMetrics
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_CUSTOM_METRICS_H_
