...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_PROFILE_FILTER_LINKS_H_
#define  GOOGLE_ANALYTICS_API_PROFILE_FILTER_LINKS_H_
 ...
 * @ingroup DataObject
 */
class ProfileFilterLinks : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit ProfileFilterLinks(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ProfileFilterLinks(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~ProfileFilterLinks();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_analytics_api::ProfileFilterLinks</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::ProfileFilterLinks";
  }
   ...
   */
  const client::JsonCppArray<ProfileFilterLink > get_items() const;
   ...
   */
  client::JsonCppArray<ProfileFilterLink > mutable_items();
 ...
 private:
  void operator=(const ProfileFilterLinks&);
};  // ProfileFilterLinks
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_PROFILE_FILTER_LINKS_H_
