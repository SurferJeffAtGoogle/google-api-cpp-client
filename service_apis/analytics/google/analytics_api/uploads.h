...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_UPLOADS_H_
#define  GOOGLE_ANALYTICS_API_UPLOADS_H_
 ...
 * @ingroup DataObject
 */
class Uploads : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Uploads(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Uploads(Json::Value* storage);
   ...
   *
   * @return <code>google_analytics_api::Uploads</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::Uploads";
  }
   ...
   */
  const client::JsonCppArray<Upload > get_items() const;
   ...
   */
  client::JsonCppArray<Upload > mutable_items();
 ...
 private:
  void operator=(const Uploads&);
};  // Uploads
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_UPLOADS_H_
