...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_CUSTOM_DATA_SOURCES_H_
#define  GOOGLE_ANALYTICS_API_CUSTOM_DATA_SOURCES_H_
 ...
 * @ingroup DataObject
 */
class CustomDataSources : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit CustomDataSources(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit CustomDataSources(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~CustomDataSources();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_analytics_api::CustomDataSources</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::CustomDataSources";
  }
   ...
   */
  const client::JsonCppArray<CustomDataSource > get_items() const;
   ...
   */
  client::JsonCppArray<CustomDataSource > mutable_items();
 ...
 private:
  void operator=(const CustomDataSources&);
};  // CustomDataSources
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_CUSTOM_DATA_SOURCES_H_
