...
//     C++: 0.1.5
#ifndef  GOOGLE_ANALYTICS_API_CUSTOM_DIMENSIONS_H_
#define  GOOGLE_ANALYTICS_API_CUSTOM_DIMENSIONS_H_
 ...
 * @ingroup DataObject
 */
class CustomDimensions : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit CustomDimensions(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit CustomDimensions(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~CustomDimensions();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_analytics_api::CustomDimensions</code>
   */
  const char* GetTypeName() const {
    return "google_analytics_api::CustomDimensions";
  }
   ...
   */
  const client::JsonCppArray<CustomDimension > get_items() const;
   ...
   */
  client::JsonCppArray<CustomDimension > mutable_items();
 ...
 private:
  void operator=(const CustomDimensions&);
};  // CustomDimensions
}  // namespace google_analytics_api
#endif  // GOOGLE_ANALYTICS_API_CUSTOM_DIMENSIONS_H_
